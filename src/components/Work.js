          ...
          className='flex-1 flex flex-col gap-y-12 mb-10 lg:mb-0'>
            ...
            rounded-xl'>
              ...
              transition-all duration-300'></div>
                ...
                transition-all duration-700 z-50'>
                  <span className='text-3x1 text-white'>Panelista</span>
                </div>
              </div>
            ...
            <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl'>
              ...
              transition-all duration-300'></div>
                ...
                <div className='absolute -bottom-full left-12 group-hover:bottom-24 
                transition-all duration-500 z-50'>
                 <span className='text-gradient'>Modelo & Actriz</span> 
                  </div>
                {/* titulo */}
                <div className='absolute -bottom-full left-12 group-hover:bottom-14 
                transition-all duration-700 z-50'>
                  <span className='text-3x1 text-white'>Barbie Velez</span>
                </div>
              </div>
            ...
            <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl'>
              ...
              transition-all duration-300'></div>
                ...
                <div className='absolute -bottom-full left-12 group-hover:bottom-24 
                transition-all duration-500 z-50'>
                 <span className='text-gradient'>Cantante</span> 
                  </div>
                {/* titulo */}
                <div className='absolute -bottom-full left-12 group-hover:bottom-14 
                transition-all duration-700 z-50'>
                  <span className='text-3x1 text-white'>Apache Ness</span>
                </div>
              </div>
